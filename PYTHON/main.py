...
PICK_POS = None
SORT_POS = {
    "RED":     [260.25, 126.73, 10.55, 25.96], # 실측해서 넣자.
    "GREEN":   [263.29, -6.47, 19.36, -1.41], # 실측해서 넣자.
    "BLUE":    [263.05, -131.31, 9.98, -26.53], # 실측해서 넣자.
}
step = 0
move_sent = False
...
def initialize_vision():
    vision = RealSenseColorDetector(roi_area=(0, 190, 135, 185))
